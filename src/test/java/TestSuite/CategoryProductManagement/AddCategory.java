...
import CSVDataProvider.CategoryData;
...
public class AddCategory extends Initialization {
	...
	@Test(dataProvider = "categoryData", dataProviderClass = CategoryData.class)
	public void QLDMSP_01(String id, String categoryName, String description, String expectedMsg) throws Exception {
		Utilities.testID = id;
		AddCategoryScreen.addCategory(driver, categoryName, description, expectedMsg);
	}
}
