...
public class ProductListScreen {
	...
	public static WebDriver openScreen(String browser) {
		...
		if (!browser.isEmpty()) {
			...
			Utilities.clickObscuredElement(driver, HomeAdminScreen.PRODUCT_LINK_XPATH, HomeAdminScreen.PRODUCT_LIST_LINK_XPATH, Constant.WAIT_ELEMENT_EXIST);
			Utilities.clickObscuredElement(driver, HomeAdminScreen.PRODUCT_LIST_LINK_XPATH, ADD_BTN_XPATH, Constant.WAIT_ELEMENT_EXIST);
		}
		return driver;
	}
	...
	public static void deleteProduct(WebDriver driver, String index, boolean isOK) throws Exception {
		...
		org.openqa.selenium.WebElement deleteBtn = driver.findElement(By.xpath(DELETE_BTN_XPATH.replace(Constant.INDEX_TEXT, index)));
